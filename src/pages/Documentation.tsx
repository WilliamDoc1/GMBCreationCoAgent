        ...
        <div className="space-y-10">
          <section id="legal-compliance">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-semibold dark:text-white">Legal & Transparency</h2>
            </div>
            <Card className="border-green-100 dark:border-green-900/30 bg-green-50/20 dark:bg-green-900/5 shadow-sm">
              <CardContent className="pt-6 space-y-4">
                <p className="text-sm text-slate-700 dark:text-slate-300">Your legal documents have been updated to meet Google's strict requirements:</p>
                <ul className="list-disc ml-6 space-y-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <section id="demo-video">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-semibold dark:text-white">Mandatory Demo Video</h2>
            </div>
            <Card className="border-blue-100 dark:border-blue-900/30 bg-blue-50/30 dark:bg-blue-900/5 shadow-sm">
              <CardContent className="pt-6 space-y-4">
                <p className="text-sm text-slate-700 dark:text-slate-300">Google requires a video showing the end-to-end OAuth flow. Ensure your video includes:</p>
                <ul className="list-decimal ml-6 space-y-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <section id="google-verification">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-semibold dark:text-white">Google OAuth Configuration</h2>
            </div>
            <Card className="border-blue-100 dark:border-blue-900/30 bg-blue-50/30 dark:bg-blue-900/5 shadow-sm">
              <CardHeader>
                <CardTitle className="text-sm dark:text-white">Authorized Redirect URIs</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="bg-white dark:bg-slate-900 px-2 py-1 rounded border dark:border-slate-800 text-xs flex-1 truncate dark:text-slate-300">https://uqqzyqgypljxvmnguhky.supabase.co/functions/v1/gmb-callback</code>
